...
import "../../css/modules/customer/CustomerUpdateDialog.css"; // Importing CSS file for styling
    ...
    <div className="update-customer-modal">
      <div className="update-customer-wrapper">
        ...
        <form className="update-customer-form" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="update-customer-form-actions">
            <button type="button" className="update-customer-btn-cancel" onClick={onClose}>
              Cancel
            </button>
            <button type="button" className="update-customer-btn-save" onClick={handleUpdate}>
              Update Customer
            </button>
          </div>
        </form>
