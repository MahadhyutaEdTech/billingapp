...
import "../../css/modules/organization/AddOrganizationPage.css";
...
const AddOrganizationPage = ({ onClose }) => {
  ...
  useEffect(() => {
    ...
    // Listen for storage changes (if dark mode is toggled elsewhere)
  ...
  return (
    <div className={`organization-container ${isDarkMode ? 'dark-mode' : ''}`}>
