...
router.get("/customers", authMiddleware, getTotalCustomersCount);
router.get("/average", authMiddleware, getAverageInvoice);
router.get("/highestSale", authMiddleware, getHighestSaleProducts);
